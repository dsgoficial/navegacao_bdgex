ol.control.Sidebar = function (settings) {
    ...
    this.lastTab=this._panes[this._panes.length-1].id;
};
...
ol.control.Sidebar.prototype.openLast = function(id) {
    this.open(this.lastTab);
    return this;
};
...
ol.control.Sidebar.prototype.hasActive = function () {
    return this.classList.contains('active');    
};

ol.control.Sidebar.prototype._onClick = function(e) {
    e.preventDefault();
